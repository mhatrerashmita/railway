...
<div className="searchItem">
    ...
    <div className="siDesc">
        <h1 className="siTitle">Aiden by Best Western Hennur</h1>
        <span className="siDistance">Located in Bangalore, 10 km from Commercial Street</span>
    ...
    <div className="siDetails">
        ...
        <div className="siDetailTexts">
            <span className="siPrice">₹ 9,324</span>
